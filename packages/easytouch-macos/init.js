...
const helperCommandName = "easytouch-macos";
...
function printUsage() {
  process.stdout.write(
    [
      "Usage:",
      "  easytouch-macos init [--output <path>] [--force]",
      "  npx easytouch-macos init [--output <path>] [--force]",
      "  node init.js [init] [--output <path>] [--force]",
      "",
      "Behavior:",
      "  Copies the current macOS binary out of this package as 'et' by default.",
